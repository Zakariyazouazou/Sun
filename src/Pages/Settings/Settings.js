...
import MyImg from '../../assets/all_pic/mon_img.jpg'
import './Settings.css'
const Settings = () => {
  return (
    <>   
                    ...
                    <div className="Bg-white  shadow rounded-lg d-block d-sm-flex">
                        <div className="profile-tab-nav border-right">
                            <div className="p-4">
                                <div className="img-circle text-center mb-3">
                                    <img src={MyImg} alt="Image" className="shadow"/>
                                </div>
                                <h4 className="text-center">Zakaria Zouazou</h4>
                            </div>
                        ...
                        <div className="tab-content p-4 p-md-5" id="v-pills-tabContent">
                            <div className="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                                ...
                                <div>
                                    <button className="btn btn-primary BBNE text-center BBNE">Update</button>
                            ...
                            <div className="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                                ...
                                <div>
                                    <button className="btn btn-primary BBNE text-center">Update</button>
                                    <button className="btn btn-light">Cancel</button>
                                </div>
                            </div>
